      ...
      <div className="header container-fluid">
        <div className="d-flex justify-content-center align-items-center h-100">
          <div className="row back py-5 text-center justify-content-center">
            <h1 className="col-12 display-1 fw-bold dark text-center mb-3">Yappa</h1>
            <div className="col-3 d-flex justify-content-center">
              <img className="img-fluid" src={logo} alt="user" />
            </div>
            <div className="col-6 back justify-content-center py-5">
              <div className="mb-3">
                <h5 className="dark text-center">Instant messaging for chatty people</h5>
              </div>
              <div className="d-flex justify-content-center align-items-center">
                <form className="username__form" onSubmit={handleSubmit}>
                  <label className="dark text-center" htmlFor="username">
                    Username
                  </label>
                  <input
                    type="text"
                    ...
                    name="username"
                    id="username"
                    className="form-control username__input"
                    value={userName}
                    onChange={(e) => setUserName(e.target.value)}
                  />
